...
More recently, ASH features interfaces to machine-learning interatomic potential (MLIP) libraries such as Fairchem(UMA), MACE, TorchANI and Mlatom and can be used to both run and train MLIP potentials.
